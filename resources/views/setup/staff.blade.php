...
<form role="form" class="form-horizontal" enctype="multipart/form-data" action="{{
   ...
   <div class="form-row">
      <div class="form-group col-md-6">
         <label>@lang('Allow staffs to browse work') <span class="required">*</span></label>
         <?php
      ...
      <div class="form-group col-md-6 staff-payment-inputs">
         <label>@lang('Staff payment type') <span class="required">*</span></label>
         <?php
   ...
   <div class="form-group staff-payment-inputs">
      <label>@lang('Staff payment amount') <span class="required">*</span>

...
<form role="form" class="form-horizontal" enctype="multipart/form-data" action="{{
   ...
   <div class="form-group">
      <label class="form-control-label">@lang('Company Name') <span class="required">*</span></label>
   ...
   <div class="form-group">
      <label>@lang('Number of times a customer can request for revision of their work')
      <small class="text-muted"> (@lang('Enter -1 for unlimited times')) </small><span class="required">*</span></label>
   ...
   <div class="form-row">
      <div class="form-group col-md-6">
         <label>@lang('Email for receiving notifications') <span class="required">*</span>
   ...
   <div class="form-group">
      ...
      <div class="custom-control custom-checkbox">
         ...
         {{ $hide_website }}
         >
         <label class="custom-control-label" for="hide_website">@lang('Hide Website')</label>
      </div>
   </div>
</form>
@endsection

...
<form role="form" class="form-horizontal" enctype="multipart/form-data" action="{{ route('patch_settings_email') }}" method="post" autocomplete="off" >
   ...
   <div class="row">
      <div class="form-group col-md-6">
         <label>@lang('Send email using')<span class="required">*</span></label>
         <?php
      ...
      <div class="form-group col-md-6 configuration">
         <label>@lang('Queue Connection') <span class="required">*</span></label>
         <?php
   ...
   <div class="form-group">
      <label>@lang('Email From Address') <span class="required">*</span></label>
   ...
   <div id="mailgunInfo">
      <div class="form-row">
         <div class="form-group col-md-6">
            <label>@lang('Mailgun Domain') <span class="required">*</span></label>
         ...
         <div class="form-group col-md-6">
            <label>@lang('Mailgun Key') <span class="required">*</span></label>
   ...
   <div id="otherMailConfigInfo">
      <div class="form-row">
         <div class="form-group col-md-6">
            <label>@lang('Smtp Host') <span class="required">*</span></label>
         ...
         <div class="form-group col-md-3">
            <label>@lang('SMTP Port') <span class="required">*</span></label>
         ...
         <div class="form-group col-md-3">
            <label>@lang('Email Encryption') <span class="required">*</span></label>
            <?php
      ...
      <div class="form-row">
         <div class="form-group col-md-6">
            <label><i class="fa fa-question-circle" data-toggle="tooltip" data-title="Fill only if your email client use username for SMTP login." data-original-title="" title=""></i> @lang('SMTP Username')</label>
         ...
         <div class="form-group col-md-6">
            <label>@lang('Smtp Password') <span class="required">*</span> </label>

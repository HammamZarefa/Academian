...
<form id="settingsForm" role="form" class="form-horizontal" enctype="multipart/form-data" action="{{
   ...
   <div class="form-group">
      <div class="custom-control custom-checkbox">
         ...
         >
         <label class="custom-control-label" for="disable_writer_application">@lang('Disable "Writer\'s Application"')</label>
      </div>
   </div>
   ...
   <div class="form-group">
      <div class="custom-control custom-checkbox">
         ...
         >
         <label class="custom-control-label" for="show_writer_application_link_website_top_menu">@lang('Show link to Writer\'s Application page, on website\'s top menu')</label>
      </div>
   </div>

   <div class="form-group">
      <label>@lang('Writer\'s application page link - Menu Title') <span class="required">*</span></label>
   ...
   <div class="form-group">
      <label>@lang('Writer\'s application page title') <span class="required">*</span></label>
   ...
   <div class="form-group">
      <label>@lang('Writer\'s application Form title') <span class="required">*</span></label>
   ...
   <div class="form-group">
      <label>@lang('Writer\'s application Form subtitle') <span class="text-muted">(Optional)</span></label>
   ...
   <div class="form-group">
      <label>@lang('Message to show after after successful form submission') <span class="required">*</span></label>
...
<div class="form-group">
   <label>@lang('Content for Writer\'s application page')</label>

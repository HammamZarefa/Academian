...
<div class="card">
   ...
   <div class="text-center">
      <a href="{{ route('download_attachment', 'file=' .  $attachment->name) }}" class="btn btn-light btn-lg btn-block"><i class="fas fa-download"></i>@lang('Download') </a>
   </div>
   <br>
   <div>
      <div class="font-weight-bold">@lang('Message'):</div>
      <p>
         {{ $attachment->message}}
      </p>
   ...
   @else
      <p class="alert alert-info" role="alert">
          @lang('A downlodable link will apprear here when your order is ready')
      </p>
   @endif
   </div>
</div>

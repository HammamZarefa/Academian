        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="payments">
                        <a class="dropdown-item" href="{{ route('posts') }}">Blog</a>
                        <a class="dropdown-item" href="{{ route('post_categories') }}">Categories</a>
                        <a class="dropdown-item" href="{{ route('post_tags') }}">Tag</a>
                        <a class="dropdown-item" href="{{ route('wallet_transactions') }}">Trash</a>
                    </div>
                </li>
                ...
                @else
                    ...
                    <li class="nav-item dropdown" style="z-index: 2000 !important;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @hasanyrole('staff|admin')
                            <a class="dropdown-item" href="{{ route('my_account',['group' => 'wallet']) }}">My
                                Wallet</a>

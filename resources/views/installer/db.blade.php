...
<div class="card mx-auto mt-5" style="width: 28rem; margin-bottom: 10%; font-size: 13px;">
   <div class="card-body">
      <h4 class="card-title">@lang('Database Information')</h4>
      <hr>
      ...
      <form action="{{ route('run_installation_step_2') }}" method="POST">
        {{ csrf_field()  }}
         <div class="form-group">
            <label>@lang('App Base URL')</label>
            <span class="form-text" style="font-size: 12px;">@lang('Base URL must not have space and it should end with a trailing slash')</span>
         ...
         <div class="form-group">
            <label>@lang('Database User Name')</label>
         ...
         <a class="btn btn-secondary  float-md-left" href="{{ route('installer_page') }}">@lang('Back')</a>

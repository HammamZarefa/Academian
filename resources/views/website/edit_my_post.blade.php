...
@section('content')
    ...
    <form role="form" class="form-horizontal" enctype="multipart/form-data" style="margin-top: 25px;"
          action="{{ (isset($post->id)) ? route( 'post.update_my_post', $post->id) : route('post.store') }}"
                    ...
                    <div class="col-md-10">
                        <div class="picture-container">
                            <div class="picture" style="text-align: -webkit-center;">
                                <img src="{{asset(Storage::url($post->cover))}}" class="picture-src"
                                     id="wizardPicturePreview" height="400px" width="100%"
                                     title=""/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <select name='tags[]'
                                class="form-control {{$errors->first('tags') ? "is-invalid" : "" }} select2"
                                id="tags" multiple>
                    ...
                    <div class="col-md-10">
                        ...
                        @foreach(Config::get('app.available_locales') as $lang)
                            <textarea id="body_{{$lang}}" type="text"
                                      class="form-control form-control-sm {{ showErrorClass($errors, 'body.*') }}"
                                      name="body[{{$lang}}]"
                    ...
                    <div class="col-md-10">
                        ...
                        @foreach(Config::get('app.available_locales') as $lang)
                            <textarea id="meta_desc_{{$lang}}" type="text"
                                      ...
                                      name="meta_desc[{{$lang}}]"
                                      style="display: {{$lang == Config::get('app.locale') ? "block" : "none"}}">{{ $post->getTranslation('meta_desc',$lang) }}</textarea>
                        @endforeach

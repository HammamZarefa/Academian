...
@include('setup.partials.action_toolbar', [
    ...
    <form role="form" class="form-horizontal" enctype="multipart/form-data" action="{{ (isset($post->id)) ? route( 'post.edit', $post->id) : route('post.storeBlog') }}" method="post" autocomplete="off" >
        {{ csrf_field()  }}

<div class="card">
   <div class="card-body">
      <div class="card-title">@lang('Change password')</div>
      <hr>
      <form autocomplete="off" class="form-horizontal" method="post" action="{{ route('change_password') }}">
         {{ csrf_field()  }}
         {{ method_field('PATCH') }}
         <div class="form-group">
            <label>@lang('Current Password') <span class="required">*</span></label>
         ...
         <div class="form-group">
            <label>@lang('New password') <span class="required">*</span></label>
         ...
         <div class="form-group">
            <label>@lang('Retype Password') <span class="required">*</span></label>

<div class="card">
   <div class="card-body">
      ...
      <div class="d-lg-flex mt-4">
         ...
         <div class="d-flex align-items-center mr-lg-5 mb-3 mb-lg-0">
            ...
            <div class="pl-3">
               ...
               <span class="h6">{{ $ratingCount = $user->ratings_received()->get()->count()}}@lang('feedback from clients') </span></a>
            </div>
         </div>
         @if(optional($user->meta)->resume)
         <div>
            <a class="" href="{{ route('download_attachment', ['file' => optional($user->meta)->resume]) }}"><i class="fas fa-file-download"></i> @lang('Download Resume')</a>
         </div>
         @endif
      </div>
      ...
      <div class="pt-5 mt-5 delimiter-top">
         ...
         <div class="pt-5 mt-5 delimiter-top">
            <!-- Title -->
            <h6 class="mb-4">@lang('Feedback from clients') (@lang('Most recent') 5) <a href="{{ route('user_profile', $user->id) }}?group=ratings">@lang('See All')</a></h6>
            <ul class="list-unstyled">
               ...
               <li class="media mb-5">
                  ...
                  <div class="media-body">
                     ...
                     <p>{{ $rating->comment }}</p>
                     <a href="{{ route('orders_show', $rating->order_id) }}"><small class="form-text text-muted">@lang('View order')</small></a>
                  </div>
               </li>
               @endforeach
            </ul>
